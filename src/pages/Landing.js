    ...
    <div>
      ...
      <div className="landAff">
        ...
        <Container>
          ...
          <ul className="affLogos">
            <li>
              <img src="/images/crowLogo.png" height={70} />
            </li>
            <li>
              <img src="/images/pioneerLogo.png" height={70} />
            </li>
            <li>
              <img src="/images/uwsLogo.png" height={70} />
            </li>
            <li>
              <img src="/images/mcHouseLogo.png" height={70} />
            </li>
            <li>
